...
//        $grid->column('nickname', __('Nickname'));
        ...
        $grid->column('authentication', __('Authentication'))->using(Authentication::STATUS);
//            ->display(function ($authentication) {
//            // 认证状态0未认证1初级认证2高级认证待审核3高级认证通过4高级认证拒绝
//            $auth_type = Authentication::STATUS;
