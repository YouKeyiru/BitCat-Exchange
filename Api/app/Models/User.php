...
class User extends Authenticatable implements JWTSubject
{
    ...
    protected static function boot()
    {
        ...
        static::created(function ($model) {
            UserExt::query()->create(['uid' => $model->id]);
        });
    }
    ...
    {
        return $this->hasOne(self::class, 'id','recommend_id');
    }
    ...
    {
        return $this->hasMany(ActivityUser::class, 'uid', 'id');
    }

    public function feedBack()
    {
        return $this->hasMany(FeedBack::class, 'uid', 'id');
    }

    public function userGiftLog()
    {
        return $this->hasMany(UserGiftLog::class, 'uid', 'id');
    }
